...
claim_id: "yamada-ibd62-1"
statement: "It is increasingly clear that a key pathogenic mechanism underlying development of IBD is the loss of tolerance and dysregulation of the immune response to commensal intestinal flora in genetically su"
confidence: "very-high"
confidence_rationale: "VERY HIGH. This is the consensus model. Every major textbook and guideline (ECCO, AGA, ACG) frames IBD pathogenesis this way. The convergence of genetic, microbial, epidemiological, and animal model d"
...
# yamada-ibd62-1: IBD arises from loss of immune tolerance to commensal flora in genetically susceptible individuals
