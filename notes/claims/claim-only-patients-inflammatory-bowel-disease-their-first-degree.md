...
claim_id: "yamada-ibd62-6"
statement: "Not only patients with inflammatory bowel disease but also their first-degree relatives demonstrate an alteration in intestinal permeability... Several of the IBD risk loci-associated genes, including"
confidence: "high"
confidence_rationale: "HIGH. The convergence of genetic data (barrier gene risk loci), family studies (asymptomatic relatives have increased permeability), histological findings (bacteria in inner mucus layer), and mouse mo"
...
# yamada-ibd62-6: Epithelial barrier dysfunction is genetically programmed in IBD and represents a primary defect, not just a consequence of inflammation
