...
tags:
  ...
  - society/rome
claim_id: "rome-sibo2017-3"
statement: "The arrival of new high-throughput sequencing approaches and 16S rRNA-based microarraying has further accelerated the supply of data... Although culturing may bias against bacteria that are hard to gr"
confidence: "medium"
...
# rome-sibo2017-3: Culture-independent molecular techniques (16S rRNA sequencing, metagenomics, metabolomics) represent a major advance over traditional culture, but each method has specific biases and limitations

**Source:** [[Rome Foundation SIBO Report 2017]] — Rome Foundation Working Team — SIBO: Rome Foundation Working Team Report (2017)

## The Claim

The arrival of new high-throughput sequencing approaches and 16S rRNA-based microarraying has further accelerated the supply of data... Although culturing may bias against bacteria that are hard to grow in the laboratory, PCR amplification biases against certain groups of gut bacteria.

## Evidence

Table 1 provides a comprehensive comparison of detection methods:
