...
claim_id: "yamada-ibd62-2"
statement: "In a large international collaborative study including over 75 000 patients with Crohn's disease, ulcerative colitis, and healthy controls, 163 distinct genetic risk loci were identified that met geno"
confidence: "very-high"
confidence_rationale: "VERY HIGH. These findings come from massive, replicated GWAS with stringent significance thresholds (p < 5 x 10^-8). The multi-ancestry replication strengthens confidence."
...
# yamada-ibd62-2: GWAS has identified over 200 risk loci, but genetics explains only a modest fraction of disease heritability
